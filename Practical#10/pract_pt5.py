...
#     shift_bins = int(desired_shift * time_dom.shape[0]/ 44100)
...
# if (shift_bins > 0 ):
#     shifted_freq_dom_pos[0:shift_bins] = 0
#     shifted_freq_dom_neg[-shift_bins] = 0
# else:
#     shifted_freq_dom_pos[shift_bins:] = 0
#     shifted_freq_dom_neg[:-shift_bins] = 0
...
# time_dom_out = np.fft.ifft(shifted_freq_dom)
# wavfile.write("shited_adele.wav", Fs, time_dom_out.astype("int32"))

# plt.plot(freq_dom)
# plt.plot(shifted_freq_dom)
# plt.xscale("log")
# plt.show()
...
def shift_pitch(freq_dom, time_dom,desired_shift, Fs):
    shift_bins = int(desired_shift * time_dom.shape[0]/ 44100)
